...
export const navItems = [
  ...
  { id: "writing", label: "Writing", shortcut: "5" },
  { id: "experience", label: "Experience", shortcut: "6" },
  { id: "leadership", label: "Leadership", shortcut: "7" },
  { id: "skills", label: "Skills", shortcut: "8" },
  { id: "achievements", label: "Awards", shortcut: "9" },
  { id: "contact", label: "Contact", shortcut: "0" },
] as const;
